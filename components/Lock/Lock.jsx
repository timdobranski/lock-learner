...
export default function Lock({ combo, setCombo, step, setStep, currentLockNum, setCurrentLockNum }) {
  ...
  return (
    <div className={styles.lockWrapper}>
      ...
      {/* lock face */}
      <div className={`${styles.lock} ${styles.lockFaceWrapper} ${step < 2 ? styles.hidden : ''}`}>
        <img src={'/lock-images/lock-face.png'} alt="Lock" className={styles.lockFace}/>
      ...
      {/* lock dial */}
      <div
        className={`${styles.lockDialWrapper} ${step < 2 ? styles.hidden : ''}`}
